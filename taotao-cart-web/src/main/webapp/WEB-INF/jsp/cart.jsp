...
<div class="w w1 header clearfix">
	<div id="logo"><a href="/"><img clstag="clickcart|keycount|xincart|logo" src="/images/shoplogo.png" title="返回长理网上商城商城首页" alt="返回长理网上商城商城首页"></a></div>
...
<div class="cart-inner">
    <div class="cart-thead clearfix">
        ...
        <div class="column t-price">长理网上商城价</div>
          ...
          <div class="cart-total-2014">
              <div class="cart-button">
                  <span class="check-comm-btns" id="checkout-jd">
                      <a class="checkout" href="http://localhost:8091/order/order-cart.html" clstag="clickcart|keycount|xincart|gotoOrderInfo" id="toSettlement">去结算<b></b></a>
                  </span>
                  <span class="combine-btns" style="display:none">
                      ...
                      <span class="fore2 hide" style="display: inline;">
                          <a href="javascript:goToOverseaOrder();" class="checkout-jdInt">去长理网上商城国际结算<b></b></a>
                          <a href="javascript:goToOrder();" class="checkout-jd">去长理网上商城结算<b></b></a>
                      </span>
                  </span>
              </div>
              <div class="total fr">
